...
function makeThumbnail(name_of_file) {
	...
	jQuery.get("txtRecipes/setup.txt", function(data) {
		...
		var sidebar_list = "<button class='sidebar_butt' onclick='location.href=\"http://www.anabealo.com/recipes/recipe_tags.html\"'>All Recipes</button>";
		var onclick = "";
		...
		console.log(document.getElementById("sidebar_container").innerHTML);
		document.getElementById("sidebar_container").innerHTML += sidebar_list;
	});
}
